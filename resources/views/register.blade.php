                ...
                <form action="/simpan" method="POST">
                  @csrf
                    <div class="form-group">
                        <label>NIK</label>
                        <input type="integer" name="nik" class="form-control" placeholder="Masukkan NIK" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="integer" name="no_hp" class="form-control" placeholder="Masukkan Nomor HP" required>
                    </div>
                    <div class="form-group">
                        <label>E-mail</label>
